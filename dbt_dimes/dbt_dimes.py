...
def create_stg_yaml(source_name: str, table_list: list,
                    save_path: Path):
    '''
    Takes list of staged tables and generates a yaml config file for them
    ...
    source_name: str
        Name of data source
    table_list : list
        List of tables to add to yaml file.
    export_path: Path
        Where do you want to yaml file to save to.
